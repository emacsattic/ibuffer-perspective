...
;;; Use:
;; To enable ibuffer-perspective:
;;
;; ;; Put ibuffer-perspective.el in your load path
;; (autoload 'ibuffer-perspective-list "ibuffer-perspective" "ibuffer-perpective" t )
